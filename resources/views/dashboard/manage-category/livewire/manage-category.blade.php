<div>
    <div>
                ...
                <div class="card-header d-flex flex-column ">
                    <div class="mt-3 d-md-inline-flex">
                        <div class="d-block mb-3">
                            <button type="button" wire:click="addManageCategory" class="btn btn-outline-success">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-plus-lg" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
                                        d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z" />
                                </svg>
                                <span>Tambah Kategori UMKM</span>
                            </button>
                        </div>
        ...
        <x-modal name="{{ $formAction }}.Category" wire:model="{{ $formAction }}">
            <x-input name="nama" label="nama kategori" placeholder="pengabdian masyarakat" />
            <x-input name="angka" label="rentang" placeholder="50.000.000" />
            <x-select name="status" label="status kategori">
