<div>
            ...
            <div class="card-header d-flex flex-column ">
                <div class="mt-3 d-md-inline-flex">
                    <div class="d-block mb-3">
                        <button type="button" wire:click="addAkunPembayaran" class="btn btn-outline-success">
    ...
    <x-modal name="{{ $formAction }}.Akun" wire:model="{{ $formAction }}">
        <x-input name="nama" label="Nama Akun" placeholder="bendahara" />
        <x-input name="type" label="Tipe Akun" placeholder="OVO" />
        <x-input name="number" label="Nomor Akun" placeholder="35621476523" />
