                ...
                <div class="card-header d-flex flex-column ">
                    ...
                    <div class="mt-3 d-md-inline-flex">
                        <div class="d-block mb-3">
                            <button type="button" wire:click="addPenerimaPerizinan" class="btn btn-outline-success">
...
{{--     
                            ...
                            <tbody class="table-hover">
                                @forelse ($data as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->pemilik }}</td>
                                        {{-- <td>{{ $item->umkmPerizinan->no_perizinan }}</td> --}}
                                        <td>
         ...
         <x-modal name="{{ $formAction }}.PenerimaPerizinan" wire:model="{{ $formAction }}">
       
            <x-select name="umkm_id" label="UMKM">
            ...
            {{-- <x-input name="no_perizinan" label="no perizinan" placeholder="no" /> --}}
