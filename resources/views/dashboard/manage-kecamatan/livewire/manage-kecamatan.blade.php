<div>
    <div>
                ...
                <div class="card-header d-flex flex-column ">
                    <div class="mt-3 d-md-inline-flex">
                        <div class="d-block mb-3">
                            <button type="button" wire:click="addManageKecamatan" class="btn btn-outline-success">
        ...
        <x-modal name="{{ $formAction }}.Kecamatan" wire:model="{{ $formAction }}">
       
            <x-input  name="nama" label="nama kecamatan" placeholder="pengabdian masyarakat" />
