<div>
    <div>
                ...
                <div class="card-header d-flex flex-column ">
                    <div class="mt-3 d-md-inline-flex">
                        <div class="d-block mb-3">
                            <button type="button" wire:click="addManagePerizinan" class="btn btn-outline-success">
                            ...
                            <tbody class="table-hover">
                                @forelse ($data as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name_perizinan }}</td>
                                       
                                     
                                        <td>
                                            <span><a href="{{'/umkm/perizinan/'.$item->slug_perizinan }}"> <button type="button"
        ...
        <x-modal name="{{ $formAction }}.Perizinan" wire:model="{{ $formAction }}">
            <x-input name="nama" label="nama perizinan" placeholder="NIB" />
        </x-modal>
    </div>
